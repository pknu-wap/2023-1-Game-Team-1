...
number normalAttackDamage = 0
number teleportDamage = 0
number breathDamage = 0
...
void OnBeginPlay()
{
	...
	if self.BossComponent.BossLevel == 1 then
		self.BossComponent.MaxHp = 2000 * 100
		self.BossComponent.Hp = self.BossComponent.MaxHp
		
		self.normalAttackDamage = 200
		self.teleportDamage = 500
		self.breathDamage = 700
	elseif self.BossComponent.BossLevel == 2 then
		self.BossComponent.MaxHp = 10000
		self.BossComponent.Hp = self.BossComponent.MaxHp
		
		self.normalAttackDamage = 1000
		self.teleportDamage = 2000
		self.breathDamage = 4500
	elseif self.BossComponent.BossLevel == 3 then
		self.BossComponent.MaxHp = 20000
		self.BossComponent.Hp = self.BossComponent.MaxHp
		
		self.normalAttackDamage = 2500
		self.teleportDamage = 5000
		self.breathDamage = 7000
	end
...
HandlePattern_Event(Pattern_Event event)
{
	...
	if self.BossComponent.InRange then
		if PtNo >= 0 and PtNo <= 3 then
			...
			self.damage = self.normalAttackDamage
		...
		elseif PtNo >= 1 and PtNo <= 3 then
			...
			self.damage = self.teleportDamage
