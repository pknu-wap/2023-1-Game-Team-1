...
void ChangeUI(string job)
{
	...
	--elseif job == "wand" then
	--    self:SetIcons("WandSkillData")
	--elseif job == "dagger" then
	--    self:SetIcons("DaggerSkillData")
	--end
}
...
void OnUpdate(number delta)
{
	...
	--elseif job == "dagger" then
	--    skills = {_DaggerSkill1, _DaggerSkill2, _SwordSkill3, _SwordSkill4, _SwordSkill5, _SwordSkill6, _SwordUltimateSkill}
	--end
	--
	--for i = 1, 6 do
