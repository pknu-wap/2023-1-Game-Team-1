...
void UseSkillServer(Entity player, number delay)
{
	...
	_TimerService:SetTimerOnce(function() 	
		player.AttackComponent:Attack(self.attackSize[1], self.attackOffset[1] * player.PlayerControllerComponent.LookDirectionX, "wa2", CollisionGroups.Player)
	end, delay)
}
...
void EnableBuff(Entity player)
{
	...
	player.ExtendPlayerComponent:RecoverHp(self.coefficient[1])
}
