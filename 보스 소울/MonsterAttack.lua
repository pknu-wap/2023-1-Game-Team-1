...
void OnBeginPlay()
{
	...
	_ResourceService:PreloadAsync({self.Entity.SpriteRendererComponent.SpriteRUID}, function()
		---@type table
		local frames = _ResourceService:LoadAnimationClipAndWait(self.Entity.SpriteRendererComponent.SpriteRUID).Frames
		local firstFrameSprite = frames[1].FrameSprite
